...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=$def_bg
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=def_fg
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=def_fg
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=def_fg
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=3
  # Custom icon.
